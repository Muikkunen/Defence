...
class BoardGraphicsItem(QtWidgets.QGraphicsPixmapItem):
	...
	def __init__(self, type, placement, square_size):
		...
		if self.type == "ROUTE":
			self.setPixmap(QPixmap("images/Route.png"))
		elif self.type == "ROUTE_UP":
			self.setPixmap(QPixmap("images/Route_up.png"))
		elif self.type == "ROUTE_DOWN":
			self.setPixmap(QPixmap("images/Route_down.png"))
		elif self.type == "ROUTE_LEFT":
			self.setPixmap(QPixmap("images/Route_left.png"))
		elif self.type == "ROUTE_RIGHT":
			self.setPixmap(QPixmap("images/Route_right.png"))
		elif self.type == "ROUTE_INNER_NORTH_EAST":
			self.setPixmap(QPixmap("images/Route_inner_north_east"))
		elif self.type == "ROUTE_INNER_NORTH_WEST":
			self.setPixmap(QPixmap("images/Route_inner_north_west"))
		elif self.type == "ROUTE_INNER_SOUTH_EAST":
			self.setPixmap(QPixmap("images/Route_inner_south_east"))
		elif self.type == "ROUTE_INNER_SOUTH_WEST":
			self.setPixmap(QPixmap("images/Route_inner_south_west"))
		elif self.type == "ROUTE_OUTER_NORTH_EAST":
			self.setPixmap(QPixmap("images/Route_outer_north_east"))
		elif self.type == "ROUTE_OUTER_NORTH_WEST":
			self.setPixmap(QPixmap("images/Route_outer_north_west"))
		elif self.type == "ROUTE_OUTER_SOUTH_EAST":
			self.setPixmap(QPixmap("images/Route_outer_south_east"))
		elif self.type == "ROUTE_OUTER_SOUTH_WEST":
			self.setPixmap(QPixmap("images/Route_outer_south_west"))
		elif self.type == "BOARD":
			self.setPixmap(QPixmap("images/Board.png"))
